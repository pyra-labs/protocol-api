...
export const buildUpgradeAccountTransaction = async (address, connection, quartzClient) => {
    let user;
    try {
    ...
    const { ixs, lookupTables, signers } = await user.makeUpgradeAccountIxs(DEFAULT_CARD_TRANSACTION_LIMIT, DEFAULT_CARD_TIMEFRAME_LIMIT, DEFAULT_CARD_TIMEFRAME, DEFAULT_CARD_TIMEFRAME_RESET);
